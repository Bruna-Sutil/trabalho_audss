...
function inicia()
{
    ...
    var decode = function()
    {
        ...
        var passwordFail = 'Chave incorreta ou a imagem não possui chave oculta';
    ...
    encodeButton.addEventListener('click', function(event)
    {
        ...
        {
            alert('Menssagem muito grande para a imagem');
            return;
        }
    ...
    tomafotoBtn.addEventListener('click', function(e)
    {
        if(!ejecutaVideo)
        {
            ...
            function(err)
            {
                ...
                console.log("Navegador não suporta getMedia");
            });
